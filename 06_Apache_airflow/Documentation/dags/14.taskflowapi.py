"""
Use of TaskFlow API which allows you to create tasks using Python decorators like @task.
This is a cleaner and more intuitive way of writing tasks without needing to manually
use operators like PythonOperator. This file show how to modify the previous code (13)
to use the @task decorator.
"""
...
with DAG(
    ...
    subtracted_value=square_number(subtracted_value)
