"""
In this file I defined a DAG where the tasks are as follows:
...
def square_number(ti):
    current_value = ti.xcom_pull(key='current_value', task_ids='substract_three_task')
    new_value = current_value ** 2
...
#! The same but using **context instead of ti
# from airflow import DAG
# from airflow.operators.python import PythonOperator
